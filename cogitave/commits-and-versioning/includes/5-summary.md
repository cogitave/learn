...
- [commits-versioning](../../../../standards/docs/standards/commits-versioning.md) -
  the canonical standard, including the full decision table of engine per repo type.
- [branching-release](../../../../standards/docs/standards/branching-release.md) -
  the protected-main ruleset, environment promotion, and release flow in full.
- [`AGENTS.md`](../../../../../AGENTS.md) - re-read rule 2 (Conventional Commits)
  and rule 3 (signed commits) at the source; they are the floor every release rides on.
