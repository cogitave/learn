...
**retrieval before generation**, stated as a hard rule in
[AI-Native Development](../../../../standards/docs/standards/ai-native-development.md)
(decision: [ADR-0013](../../../../standards/docs/decisions/0013-reuse-first-convergent-ai-development.md)):
discover, compose, and only justify-and-author when nothing fits - then
contribute the result back. That rule only works because there is exactly one
...
[ADR-0003](../../../../standards/docs/decisions/0003-build-from-scratch-reference-not-dependency.md)
says port best-in-class references and rebuild them native only where the
rebuild is materially better - faster, more integrated, more correct, more
secure. Otherwise, the reference stays an explicit, time-boxed bootstrap crutch,
