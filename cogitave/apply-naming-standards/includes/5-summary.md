...
- Learned the **cross-cutting naming principles** from the
  [naming standard](../../../../standards/docs/standards/naming.md) - keyword-first,
  no redundant prefix, casing by role, immutable IDs with mutable facts in
  metadata - and that naming is **machine-enforced** by CI gates, not reviewer
  goodwill.
...
- Separated a **functional keyword** from a **product codename**: the Roots
  ...
  when a primitive is codename-exempt
  ([ADR-0007](../../../../standards/docs/decisions/0007-keyword-naming.md),
  [codename standard](../../../../standards/docs/standards/codenames.md)).
...
- [The naming standard](../../../../standards/docs/standards/naming.md) - the full
  per-domain reference (cloud tags, databases, observability, events, IaC) for
  when you need a rule this module did not cover.
